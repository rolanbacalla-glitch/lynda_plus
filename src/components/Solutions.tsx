...
const Solutions: React.FC = () => {
  ...
  return (
    <section id="solutions" className="py-20 md:py-24 bg-white border-y border-slate-100">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="flex flex-col md:flex-row gap-12 md:gap-24">
          ...
          <div className="md:w-1/3 text-left md:text-left">
            ...
            <p className="text-[17px] md:text-lg text-slate-500 font-medium leading-relaxed max-w-xs transition-all">
              We have solutions for a range of roles, industries, and use cases.
            </p>
          </div>

          {/* Grid Section */}
          <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-8">
            {sections.map((section, idx) => (
              <div key={idx} className="flex flex-col">
                <h3 className="text-[11px] font-bold text-slate-600 uppercase tracking-[0.2em] mb-6 md:mb-8">
                  {section.title}
                </h3>
